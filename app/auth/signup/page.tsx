...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            setMessage({
                type: 'success',
                text: 'Check your email! We sent you a magic link to create your account.',
            });
            setEmail('');
        }
            ...
            <div className="max-w-md w-full">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        Start understanding contracts in minutes
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-8 shadow-sm">
                    ...
                    <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        <p className="text-xs text-gray-600 dark:text-gray-400 text-center">
                            We'll send you a magic link to verify your email and sign in. No password needed.
                        </p>
                    </div>
                </div>
